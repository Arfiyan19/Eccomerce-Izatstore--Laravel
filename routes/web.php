...
Route::post('/checkout', 'Ecommerce\CartController@prosesOrders')->name('front.store_checkout');
...
// ===bantuan====
Route::get('/bantuanPelanggan', 'Ecommerce\FrontController@bantuanPelanggan')->name('front.bantuanPelanggan');
Route::get('/bantuanPelanggan/{slug}', 'Ecommerce\FrontController@show_bantuanPelanggan')->name('front.bantuanPelanggan.show');

// ===galeri====
Route::get('/galeri', 'Ecommerce\FrontController@galeri')->name('front.galeri');

// =====feed======
Route::get('/feed', 'Ecommerce\FrontController@feed')->name('front.feed');
Route::get('/about', 'Ecommerce\FrontController@about')->name('front.about');


Route::get('/testing', 'OngkirController@getLocation');
// Route::get('asu','CartController@asu')->name('asu');
Route::get('getCourier', [CartController::class, 'getCourier']);

Route::post('/cekOngkir', [CartController::class, 'cek2']);

Route::get('/ongkirIndex', 'OngkirController@index');
