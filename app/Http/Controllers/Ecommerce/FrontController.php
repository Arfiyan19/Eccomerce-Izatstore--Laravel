...
class FrontController extends Controller
{
    ...
    public function bantuanPelanggan()
    {

        $bantuans = bantuan::all();
        return view('ecommerce.bantuan', compact('bantuans'));
    }

    public function feed()
    {

        return view('ecommerce.feed');
    }

    public function galeri()
    {
        $galeris = galeri::all();
        return view('ecommerce.galeri', compact('galeris'));
    }

    public function about()
    {
        $abouts = About::all();
        return view('ecommerce.about', compact('abouts'));
    }
