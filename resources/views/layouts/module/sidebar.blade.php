  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              <div class="image">
                  <img src="{{ asset('admin-lte/dist/img/izzatstorelogo.png')}}" class="img-circle elevation-2" alt="User Image">
              </div>
              <div class="info">
                  <a href="#" class="d-block">Izzat Store</a>
              </div>
          </div>
                  ...
                  <li class="nav-item has-treeview">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              ...
                              <a href="{{ route('bantuan.index') }}" class="nav-link {{Request::path() == 'administrator/bantuans' ? 'active' : ''}}">
                                  <i class="nav-icon fas fa-warehouse"></i>
                                  <p>Bantuan</p>
                              </a>
                              <!-- <li class="nav-item"> -->
                              <a href="{{ route('galeri.index') }}" class="nav-link {{Request::path() == 'administrator/galeris' ? 'active' : ''}}">
                                  <i class="nav-icon fas fa-warehouse"></i>
                                  <p>Galeri</p>
                              </a>
                              <!-- </li> -->
                              <!-- <li class="nav-item"> -->
                              <!-- route('about.index') -->
                              <a href="{{ route('about.index') }}" class="nav-link {{Request::path() == 'administrator/abouts' ? 'active' : ''}}">
                                  <i class="nav-icon fas fa-th"></i>
                                  <p>About</p>
                              </a>
                          </li>
