                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="form-group">
                                    <label for="header">Masukan Foto Perusahaan</label>
                                ...
                                <div class="form-group">
                                    <label for="sideImage">Masukan Pendiri Perusahaan</label>
                                    <input type="text" name="sideImage" class="form-control" required placeholder="Masukan Judul Bantuan">
                                    <p class="text-danger">{{ $errors->first('sideImage') }}</p>
                                </div>
                                <div class="form-group">
