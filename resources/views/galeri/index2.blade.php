            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Galeri List</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img src="/storage/galeris/{{$imag}}" width="300px" height="250px">
                                            ...
                                            <td>
                                                ...
                                                <form onsubmit="return confirm('Yakin Hapus Produk ?')" action="{{ route('galeri.destroy', $row->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
